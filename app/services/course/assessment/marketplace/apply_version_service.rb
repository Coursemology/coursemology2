...
class Course::Assessment::Marketplace::ApplyVersionService
  ...
  def duplicate_snapshot(version)
    ActsAsTenant.without_tenant do
      ...
      # Not a link-sibling of the container snapshot or of any other adopter's copy.
  ...
  # so the snapshot's would be meaningless here.
  ...
  # Slice 3's collision rule, excluding this assessment itself — its OWN old title is exactly what it
