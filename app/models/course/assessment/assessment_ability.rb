...
module Course::Assessment::AssessmentAbility
  ...
  def define_staff_assessment_permissions
    ...
    allow_staff_update_category_scores
  ...
  def allow_staff_update_category_scores
    can :update_category_scores, Course::Assessment::Submission, assessment: assessment_course_hash
  end
