class Course::Forum::TopicsController < Course::Forum::Controller
  include Course::Forum::Topic::HideConcern
  include Course::Forum::Topic::LockConcern
  include Course::Forum::Topic::SubscribeConcern
  ...
  authorize_resource :topic, class: Course::Forum::Topic.name, through: :forum
  ...
  def new
    # When create a topic, a post with the same title will be created too.
