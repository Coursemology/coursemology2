module ApplicationCocoonHelper
  ...
  #   @option html_options [Symbol] :find_using The jQuery traversal method to allow node selection
  #     relative to the link. Example values: `closest`, `next`, `children`, etc. Default: absolute
  #     selection.
  #   @option html_options [Symbol] :selector The jQuery selector to be used with +:find_using+ to
  #     determine where to insert the new node.
  #   @option html_options [Symbol] :find_selector The alias of +:selector+, you should use this
  #     when +:find_using+ is not specified. Default: parent node.
  #   @option html_options [Symbol] :insert_using ('before') The jQuery method that inserts the
  ...
  #     selection.
  #   @option html_options [Symbol] :selector The jQuery selector to be used with +:find_using+ to
  #     determine where to insert the new node. Default: parent node.
  #   @option html_options [Symbol] :find_selector The alias of +:selector+, you should use this
