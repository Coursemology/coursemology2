...
json.assessments @assessments do |assessment|
  ...
  json.similarityUrl similarity_course_assessment_path(current_course, assessment)
  json.submissionsUrl course_assessment_submissions_path(current_course, assessment)

  json.numCheckableQuestions assessment.num_similarity_checkable_questions
  json.numSubmitted num_submitted
  json.lastSubmittedAt @latest_submission_time_hash[assessment.id]&.iso8601

  json.workflowState assessment.similarity_check&.workflow_state || 'not_started'
  json.lastRunTime assessment.similarity_check&.last_started_at&.iso8601

  job = assessment.similarity_check&.job
