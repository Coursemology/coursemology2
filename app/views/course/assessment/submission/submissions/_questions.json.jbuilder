...
json.questions question_assessments.each_with_index.to_a do |(question_assessment, index)|
  ...
  # Fully-qualified: this partial is reused from a non-submissions controller (the marketplace preview
  # attempts controller), whose view-path prefixes don't include this directory, so a bare
  # 'question' reference would fail to resolve there.
