...
json.submission do
  ...
  # marks in place — a previewer has no grader colleague to refresh for them. Absent outside a
  # preview course, and absent on any request that did not itself finalise the submission.
