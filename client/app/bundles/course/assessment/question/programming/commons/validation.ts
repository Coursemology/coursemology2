        ...
        .when(['languageId', '$getDataFromId'], (languageId, getDataFromId) => {
          ...
          return boolean()
            .test({
              ...
              test: (useCodaveri) => useCodaveri || language.evaluatorSupported,
            })
            .test({
              ...
              test: (useCodaveri) => !useCodaveri || language.codaveriSupported,
            });
        }),
        ...
        (languageId, getDataFromId) => {
          ...
          return boolean().test({
            ...
            test: (useLiveFeedback) =>
              !useLiveFeedback || language.codaveriSupported,
          });
        },
      ),
      editOnline: boolean(),
