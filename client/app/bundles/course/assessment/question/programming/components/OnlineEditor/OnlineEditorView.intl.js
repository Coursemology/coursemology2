...
export default defineMessages({
  ...
  prependSubtitle: {
    id:
      'course.assessment.question.programming.onlineEditorView.prependSubtitle',
  ...
  appendSubtitle: {
    id:
      'course.assessment.question.programming.onlineEditorView.appendSubtitle',
  ...
  testCaseDescriptionPrint: {
    id:
      'course.assessment.question.programming.onlineEditorView.testCaseDescriptionPrint',
  ...
  testCaseDescriptionNone: {
    id:
      'course.assessment.question.programming.onlineEditorView.testCaseDescriptionNone',
    defaultMessage: 'None',
    description:
  ...
  testCaseDescriptionGoogleTest: {
    id:
      'course.assessment.question.programming.onlineEditorView.testCaseDescriptionGoogleTest',
    defaultMessage: 'Google Test Framework',
    description: "Name of Google's C++ test framework",
  },
  addNewTestButton: {
    id:
      'course.assessment.question.programming.onlineEditorView.addNewTestButton',
    defaultMessage: 'Add new test',
    description: 'Button for adding new test case.',
  },
  showTestCaseCodeEditorButton: {
    id:
      'course.assessment.question.programming.onlineEditorView.showTestCaseCodeEditorButton',
    defaultMessage: 'Code',
    description: 'Button for showing the test case inline code editor.',
  },
  hideTestCaseCodeEditorButton: {
    id:
      'course.assessment.question.programming.onlineEditorView.hideTestCaseCodeEditorButton',
    defaultMessage: 'Hide',
    description: 'Button for hiding the test case inline code editor.',
  },
  publicTestCases: {
    id:
      'course.assessment.question.programming.onlineEditorView.publicTestCases',
    defaultMessage: 'Public Test Cases',
    description: 'Title for public test cases panel.',
  },
  privateTestCases: {
    id:
      'course.assessment.question.programming.onlineEditorView.privateTestCases',
    defaultMessage: 'Private Test Cases',
    description: 'Title for private test cases panel.',
  },
  evaluationTestCases: {
    id:
      'course.assessment.question.programming.onlineEditorView.evaluationTestCases',
    defaultMessage: 'Evaluation Test Cases',
    description: 'Title for evaluation test cases panel.',
  },
  identifierHeader: {
    id:
      'course.assessment.question.programming.onlineEditorView.identifierHeader',
    defaultMessage: 'Identifier',
    description: 'Header for identifier column of test cases panel.',
  },
  expressionHeader: {
    id:
      'course.assessment.question.programming.onlineEditorView.expressionHeader',
    defaultMessage: 'Expression',
    description: 'Header for expression column of test cases panel.',
  },
  expectedHeader: {
    id:
      'course.assessment.question.programming.onlineEditorView.expectedHeader',
  ...
  noTestCaseErrorAlert: {
    id:
      'course.assessment.question.programming.onlineEditorView.noTestCaseErrorAlert',
    defaultMessage:
      'At least 1 test case is required for autograded programming question.',
  },
  cannotBeBlankValidationError: {
    id:
      'course.assessment.question.programming.onlineEditorView.cannotBeBlankValidationError',
