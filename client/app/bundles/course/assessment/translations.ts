...
const translations = defineMessages({
  ...
  // MarketplaceRestoreAuthoringButton's "Rebuild source assessment"). Renaming the id would orphan
  // the key in all three locale files for a copy change; `authoring_assessment` is unaffected.
