  ...
  return (
    <>
      ...
      <div className="flex flex-row w-full relative min-h-[52.5rem] space-x-2">
        <div className="absolute max-h-[100%] flex w-1/2 whitespace-nowrap left-0 flex-col mb-2 flex-1 overflow-auto mt-1">
        ...
        <div
          ref={scrollableRef}
          className="absolute max-h-[100%] flex w-1/2 whitespace-nowrap right-0"
        >
