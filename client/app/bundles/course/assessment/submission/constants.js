...
export const defaultPastAnswersSelectable = 10;
...
const actionTypes = mirrorCreator([
  ...
  'ENTER_STUDENT_VIEW', 'EXIT_STUDENT_VIEW',
  ...
  'IMPORT_FILES_REQUEST', 'IMPORT_FILES_SUCCESS', 'IMPORT_FILES_FAILURE', 'STAGE_FILES',
  // View Past Answer History action types
  'TOGGLE_VIEW_HISTORY_MODE', 'SELECT_PAST_ANSWERS', 'GET_PAST_ANSWERS_REQUEST',
  'GET_PAST_ANSWERS_SUCCESS', 'GET_PAST_ANSWERS_FAILURE',
]);
