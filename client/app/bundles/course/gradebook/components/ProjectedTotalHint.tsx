...
// below and the ⓘ tooltip on the Total header (in GradebookWeightedTable) both
...
export const projectedTotalPolicyTranslations = defineMessages({
  policy: {
    ...
    defaultMessage: 'Projected totals count ungraded assessments as 0.',
  },
});

/**
 * One-time, dismissable banner shown the first time a manager opens the weighted
 * (By weight) gradebook view. It teaches the projected-total policy — ungraded
