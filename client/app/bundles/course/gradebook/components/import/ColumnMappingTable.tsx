...
const translations = defineMessages({
  helperLine: {
    ...
    defaultMessage:
      'Grade columns must contain only numbers (blank, "-" or "N/A" mean no grade). Columns with non-numeric values can\'t be imported as grades - fix the CSV or set them to Don\'t import.',
  },
  csvHeader: {
