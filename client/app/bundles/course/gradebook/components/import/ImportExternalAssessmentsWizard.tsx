...
const translations = defineMessages({
  ...
  requiredHeaders: {
    ...
    defaultMessage:
      'Your CSV must include a column named {headers} to identify students. It can be in any position.',
  },
  exampleHeader: {
  ...
  blockIdentifierMissing: {
    id: 'course.gradebook.ImportWizard.blockIdentifierMissing',
    defaultMessage:
      'This file needs a column named “{expected}” to identify students. Add one, or switch how you match students above.',
  },
  blockNoGradeColumns: {
  ...
  resolveConflicts: {
    id: 'course.gradebook.ImportWizard.resolveConflicts',
  ...
  previewRows: {
    ...
    defaultMessage:
      'Previewing the first 5 of {totalRows} rows. Check that these grades match your CSV before continuing.',
  },
  previewFewRows: {
    id: 'course.gradebook.ImportWizard.previewFewRows',
    defaultMessage:
      'Previewing all {totalRows} rows. Check that these grades match your CSV before continuing.',
  },
  willChangeExisting: {
    id: 'course.gradebook.ImportWizard.willChangeExisting',
    defaultMessage:
      '{count, plural, one {# row contains} other {# rows contain}} changes to existing grades. After checking this preview, click Resolve Conflicts to review these conflicts before anything is imported.',
  },
  commitError: {
  ...
  const uploadBlockMessage = ((): string | null => {
    ...
    switch (uploadBlock.kind) {
      ...
      case 'identifierMissing':
        return t(translations.blockIdentifierMissing, {
              ...
              >
                {({ getRootProps, getInputProps }) => (
                  ...
                  >
                    <input
                      {...getInputProps({
                        'aria-label': t(translations.upload),
                      })}
                    />
                    {file ? (
          ...
          {step === 'preview' && preview?.ok && !previewError && (
            ...
            >
              {preview.conflictRows.length > 0
                ? t(translations.resolveConflicts)
