...
const translations = defineMessages({
  ...
  remarks: {
    id: 'course.gradebook.ManageExternalPanel.remarks',
    defaultMessage: 'Remarks',
  },
  noFloor: {
    id: 'course.gradebook.ManageExternalPanel.noFloor',
    defaultMessage: 'No floor',
  },
  noCap: {
    id: 'course.gradebook.ManageExternalPanel.noCap',
    defaultMessage: 'No cap',
  },
  noFloorHint: {
    id: 'course.gradebook.ManageExternalPanel.noFloorHint',
    defaultMessage:
      'Negative grades are kept as-is (not floored to 0) when computing the weighted total.',
  },
  noCapHint: {
    id: 'course.gradebook.ManageExternalPanel.noCapHint',
    defaultMessage:
      'Grades above the maximum are kept as-is (not capped) when computing the weighted total.',
  },
  actions: {
