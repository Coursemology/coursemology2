...
const destinationCourseIdSelector = state => state.duplication.destinationCourseId;
const destinationCoursesSelector = state => state.duplication.destinationCourses;
