...
export default defineMessages({
  ...
  weightedViewEnabled: {
    ...
    defaultMessage: 'Enable weighted grade view',
  },
  weightedViewEnabledHint: {
    id: 'course.admin.GradebookSettings.weightedViewEnabledHint',
    defaultMessage:
      'Enables a "By weight" view in the gradebook where staff can configure per-tab weights and see a weighted Total column.',
  },
});
