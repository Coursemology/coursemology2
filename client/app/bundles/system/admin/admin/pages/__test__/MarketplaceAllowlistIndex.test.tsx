...
const ZERO_MATCH_WARNING =
  'No eligible users currently match this rule, so it grants access to nobody.';
...
it('creates an email-domain rule from the add dialog', async () => {
  ...
  mock.onPost(PREVIEW_URL).reply(200, ONE_MATCH_PREVIEW);
