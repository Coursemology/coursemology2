...
const translations = defineMessages({
  ...
  everyoneTitle: {
    ...
    defaultMessage:
      'The marketplace is open to all eligible users: course managers/owners and instance instructors/administrators. The rules below are preserved but inactive.',
  },
  toggleLabel: {
  ...
  openConfirmBody: {
    ...
    defaultMessage:
      'This makes the marketplace visible to all eligible users: course managers/owners and instance instructors/administrators. You can restrict it again at any time; your scoped rules are kept.',
  },
  ...
  restrictConfirmBody: {
    ...
    defaultMessage:
      'The marketplace will again be limited to the rules below. Eligible users not covered by a rule will lose access.',
  },
  confirmOpen: {
