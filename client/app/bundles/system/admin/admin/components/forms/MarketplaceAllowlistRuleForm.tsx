...
const translations = defineMessages({
  ...
  fetchInstancesFailure: {
    id: 'system.admin.admin.MarketplaceAllowlistRuleForm.fetchInstancesFailure',
...
const MarketplaceAllowlistRuleForm = ({
  ...
  useEffect(() => {
    ...
    SystemAPI.admin
      ...
      // Only a success counts as loaded: leaving the flag down on failure means re-selecting the
      // type asks again, instead of stranding the admin at an unexplained empty dropdown.
