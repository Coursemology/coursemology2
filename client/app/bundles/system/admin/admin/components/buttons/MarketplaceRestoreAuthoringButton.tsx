...
const MarketplaceRestoreAuthoringButton = ({
  ...
  const submit = async (): Promise<void> => {
    ...
    try {
      ...
      // The server owns the rejection list (not orphaned, no version to restore from) and is the
      // authority on it, so surface its message verbatim rather than restating those rules here.
      const message =
