...
export default class LearningMapAPI extends BaseCourseAPI {
  ...
  */
  addParentNode(params) {
    return this.getClient().post(`${this._getUrlPrefix()}/add_parent_node`, params);
  }
  ...
  */
  removeParentNode(params) {
    return this.getClient().post(`${this._getUrlPrefix()}/remove_parent_node`, params);
  }
  ...
  */
  toggleSatisfiabilityType(params) {
    return this.getClient().post(`${this._getUrlPrefix()}/toggle_satisfiability_type`, params);
  }
