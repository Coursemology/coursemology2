...
describe('<Table /> — grouped + pinned + scroll-contained', () => {
  ...
  it('left pin has offset 0, right pin has offset 0', () => {
    ...
    const leftPin = container.querySelector(
      'th[data-table-pin="left"]',
    ) as HTMLElement;
    const rightPin = container.querySelector(
      'th[data-table-pin="right"]',
    ) as HTMLElement;
...
describe('<Table /> — flat with one pin, no maxHeight', () => {
  ...
  it('body td for pinned column has data-table-pin="left"', () => {
    ...
    const pinnedBodyCells = container.querySelectorAll(
      'td[data-table-pin="left"]',
    );
