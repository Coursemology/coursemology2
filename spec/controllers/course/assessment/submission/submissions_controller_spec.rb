...
RSpec.describe Course::Assessment::Submission::SubmissionsController do
  ...
  with_tenant(:instance) do
    ...
    # This pre-existing race (the job enqueue itself is unchanged) became far more likely to manifest
    # once the Attempt/Submission split added enough extra latency to the request handling to give
    # the background job time to complete first. Wrapping
