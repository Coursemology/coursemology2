  ...
  with_tenant(:instance) do
    ...
    describe '#generate' do
      ...
      context 'when some students have external_id set' do
        ...
        it 'student with external_id has it in the correct column' do
          ...
          expect(fourth_student_record[3]).to eq(submission_a1.grade.to_s)
          expect(fourth_student_record[4]).to eq(submission_a2.grade.to_s)
          expect(fourth_student_record[5]).to eq('EXT001')
        end

        it 'student without external_id has empty string in external_id column' do
          ...
          expect(fifth_student_record[3]).to eq(submission_b1.grade.to_s)
          expect(fifth_student_record[4]).to eq(submission_b2.grade.to_s)
          expect(fifth_student_record[5]).to eq('')
        end
      end
    end
  end
