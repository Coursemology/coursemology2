...
RSpec.describe Course::LecturesHelper do
  describe '#lectures_title' do
    ...
    context 'when the title is blank' do
      ...
      it 'returns nil' do
        expect(helper.lectures_title).to be_nil
      end
    end
    ...
    context 'when the title is set' do
      ...
      it 'returns a string' do
        expect(helper.lectures_title).to eq(settings_with_given_title.title)
      end
    end
  end
end
