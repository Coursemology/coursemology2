...
RSpec.describe Course::Settings, type: :model do
  ...
  let(:settings) do
    ...
    course_settings = MockSettings.new
    course_settings.stub_method(:settings) do |_|
      components_settings
    end
  ...
  subject { Course::Settings.new(settings) }
