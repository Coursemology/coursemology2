  ...
  with_tenant(:instance) do
    ...
    context 'when the user is a Course Student' do
      ...
      context 'when experience points record belongs to a classmate' do
        ...
        it { is_expected.not_to be_able_to(:show_user_exp, classmate_points_record) }
        ...
        it "cannot access classmate's experience points history" do
          expect(classmate.experience_points_records.accessible_by(subject, :show_user_exp)).
            to be_empty
        end
      end
      ...
      context 'when experience points record belongs to him/herself' do
        ...
        it { is_expected.to be_able_to(:show_user_exp, points_record) }
        ...
        it 'can access his/her own experience points history' do
          expect(course_student.experience_points_records.accessible_by(subject, :show_user_exp)).
    ...
    context 'when the user is a Course Teaching Staff' do
      ...
      context 'when record belongs to a student from the different course' do
        ...
        it { is_expected.not_to be_able_to(:show_user_exp, foreign_points_record) }
        ...
        it "cannot access the student's experience points history" do
          ...
          expect(records.accessible_by(subject, :show_user_exp)).to be_empty
        end
      end
    end
