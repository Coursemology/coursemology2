...
ActiveRecord::Schema[8.1].define(version: 2026_09_14_000000) do
  ...
  create_table "course_assessment_question_programming_upgrades", force: :cascade do |t|
    t.bigint "attachment_id"
    t.datetime "created_at", precision: nil, null: false
    t.bigint "creator_id", null: false
    t.uuid "job_id"
    t.bigint "new_language_id", null: false
    t.bigint "old_language_id", null: false
    t.bigint "question_id", null: false
    t.datetime "updated_at", precision: nil, null: false
    t.bigint "updater_id", null: false
    t.string "workflow_state", limit: 255, default: "pending", null: false
    t.index ["attachment_id"], name: "index_programming_upgrades_on_attachment_id"
    t.index ["creator_id"], name: "index_programming_upgrades_on_creator_id"
    t.index ["job_id"], name: "index_programming_upgrades_on_job_id"
    t.index ["new_language_id"], name: "index_programming_upgrades_on_new_language_id"
    t.index ["old_language_id"], name: "index_programming_upgrades_on_old_language_id"
    t.index ["question_id", "attachment_id"], name: "index_programming_upgrades_on_question_id_and_attachment_id", unique: true, nulls_not_distinct: true
    t.index ["updater_id"], name: "index_programming_upgrades_on_updater_id"
  end
  ...
  add_foreign_key "course_assessment_question_programming_upgrades", "attachments", on_delete: :cascade
  add_foreign_key "course_assessment_question_programming_upgrades", "course_assessment_question_programming", column: "question_id"
  add_foreign_key "course_assessment_question_programming_upgrades", "jobs", on_delete: :nullify
  add_foreign_key "course_assessment_question_programming_upgrades", "polyglot_languages", column: "new_language_id"
  add_foreign_key "course_assessment_question_programming_upgrades", "polyglot_languages", column: "old_language_id"
  add_foreign_key "course_assessment_question_programming_upgrades", "users", column: "creator_id"
  add_foreign_key "course_assessment_question_programming_upgrades", "users", column: "updater_id"
