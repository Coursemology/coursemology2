...
ActiveRecord::Schema[7.2].define(version: 2025_06_29_052451) do
  ...
  create_table "course_assessment_answer_programming_auto_gradings", id: :serial, force: :cascade do |t|
    ...
    t.text "stderr"
    t.integer "exit_code"
    t.bigint "question_snapshot_id"
    t.index ["question_snapshot_id"], name: "idx_on_question_snapshot_id_80edeb1ca8"
  end
  ...
  create_table "course_assessment_question_programming", id: :serial, force: :cascade do |t|
    ...
    t.bigint "current_id"
    t.integer "snapshot_index", null: false
    t.datetime "snapshot_of_state_at", null: false
    t.index ["current_id"], name: "index_course_assessment_question_programming_on_current_id"
  ...
  add_foreign_key "course_assessment_answer_programming_auto_gradings", "course_assessment_question_programming", column: "question_snapshot_id"
  ...
  add_foreign_key "course_assessment_question_programming", "course_assessment_question_programming", column: "current_id"
