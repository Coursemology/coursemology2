...
ActiveRecord::Schema[7.2].define(version: 2026_07_23_000001) do
  ...
  create_table "course_assessment_submission_details", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["attempt_id"], name: "unique_course_assessment_submission_details_attempt_id", unique: true
  end
  ...
  add_foreign_key "course_assessment_submission_details", "course_assessment_submissions", column: "attempt_id", name: "fk_course_assessment_submission_details_attempt_id"
  add_foreign_key "course_assessment_submission_details", "users", column: "publisher_id", name: "fk_course_assessment_submission_details_publisher_id"
