...
ReactOnRails.configure do |config|
  ...
  config.webpack_generated_files = %w(coursemology.bundle.js)

  # This is the file used for server rendering of React when using `(prerender: true)`
  # If you are never using server rendering, you may set this to "".
  # If you are using the same file for client and server rendering, having this set probably does
  # not affect performance.
  config.server_bundle_js_file = 'coursemology.bundle.js'
  ...
  # Default is false, enable if your content security policy doesn't
  # include `style-src: 'unsafe-inline'`
  ...
  # For any asset matching this regex, non-digested symlink will be created (what webpack's
  # css wants)
  # To disable symlinks set this parameter to nil.
  config.symlink_non_digested_assets_regex = /\.(png|jpg|jpeg|gif|tiff|woff|ttf|eot|svg|map)/
end

# Include ReactOnRailsHelper in all views since many pages will eventually need the helper
