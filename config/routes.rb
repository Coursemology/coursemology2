...
Rails.application.routes.draw do
  ...
  scope module: 'system' do
    namespace :admin do
      ...
      # `destroy` here is a PERMANENT purge of an orphaned listing, not the reversible unlist that
      # the course-side `marketplace_listing#destroy` performs. `update` is that reversible unlist —
        ...
        resources :assessments do
          ...
          resources :questions, only: [:show] do
            ...
            resources :rubrics, on: :member, only: [:index, :create, :destroy, :show] do
              ...
              get :grading_contexts, on: :collection, action: 'grading_contexts'
